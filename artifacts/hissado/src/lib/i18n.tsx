...
const T = {
  en: {
    ...
    // Tickets / Complaints
    nav_tickets: "Support",
    ticket_title: "Support & Requests",
    ticket_subtitle: "Submit and track your complaints, requests, and issues",
    ticket_new: "New Request",
    ticket_empty: "No submissions yet",
    ticket_empty_desc: "Submit a complaint, request, or issue using the button above.",
    ticket_empty_staff: "No tickets in this view",
    ticket_empty_staff_desc: "New submissions from clients will appear here.",
    ticket_subject: "Subject / Title",
    ticket_subject_ph: "Brief summary of your request",
    ticket_category: "Category",
    ticket_cat_complaint: "Complaint",
    ticket_cat_request: "Request",
    ticket_cat_issue: "Issue",
    ticket_cat_other: "Other",
    ticket_desc: "Description",
    ticket_desc_ph: "Please describe your complaint, request, or issue in detail…",
    ticket_project: "Related Project (optional)",
    ticket_service: "Related Service (optional)",
    ticket_none: "None",
    ticket_attachment: "Attachment (optional)",
    ticket_attach_btn: "Attach a file",
    ...
    ticket_by: "Submitted by",
    ticket_filter_all: "All Statuses",
    ticket_filter_open: "Open",
    ticket_notes: "Internal Notes",
    ticket_notes_ph: "Add an internal note (visible to staff only)…",
    ticket_add_note: "Add Note",
    ticket_no_notes: "No internal notes yet.",
    ticket_update_status: "Update Status",
    ticket_detail_title: "Ticket Details",
    ticket_close_detail: "Close",
    ticket_delete: "Delete Ticket",
    ticket_delete_confirm: "Are you sure you want to delete this ticket? This cannot be undone.",
    ticket_delete_yes: "Yes, Delete",
    ticket_notif_new: (name: string) => `New support ticket from ${name}`,
    ticket_all_clients: "All Clients",

    // Share App
    share_title: "Share App",
    share_desc: "Invite others to access the platform. Share this link — recipients will be directed to the login page.",
  ...
  fr: {
    ...
    // Tickets / Complaints
    nav_tickets: "Support",
    ticket_title: "Support & Demandes",
    ticket_subtitle: "Soumettez et suivez vos réclamations, demandes et problèmes",
    ticket_new: "Nouvelle demande",
    ticket_empty: "Aucune soumission pour l'instant",
    ticket_empty_desc: "Soumettez une réclamation, une demande ou un problème en utilisant le bouton ci-dessus.",
    ticket_empty_staff: "Aucun ticket dans cette vue",
    ticket_empty_staff_desc: "Les nouvelles soumissions des clients apparaîtront ici.",
    ticket_subject: "Sujet / Titre",
    ticket_subject_ph: "Bref résumé de votre demande",
    ticket_category: "Catégorie",
    ticket_cat_complaint: "Réclamation",
    ticket_cat_request: "Demande",
    ticket_cat_issue: "Problème",
    ticket_cat_other: "Autre",
    ticket_desc: "Description",
    ticket_desc_ph: "Veuillez décrire votre réclamation, demande ou problème en détail…",
    ticket_project: "Projet concerné (optionnel)",
    ticket_service: "Service concerné (optionnel)",
    ticket_none: "Aucun",
    ticket_attachment: "Pièce jointe (optionnel)",
    ticket_attach_btn: "Joindre un fichier",
    ticket_submit: "Soumettre",
    ticket_submitting: "Envoi en cours…",
    ticket_cancel: "Annuler",
    ticket_status_new: "Nouveau",
    ticket_status_under_review: "En cours d'examen",
    ticket_status_in_progress: "En cours",
    ticket_status_resolved: "Résolu",
    ticket_status_closed: "Fermé",
    ticket_submitted: "Soumis le",
    ticket_updated: "Mis à jour",
    ticket_by: "Soumis par",
    ticket_filter_all: "Tous les statuts",
    ticket_filter_open: "Ouverts",
    ticket_notes: "Notes internes",
    ticket_notes_ph: "Ajouter une note interne (visible par le personnel uniquement)…",
    ticket_add_note: "Ajouter une note",
    ticket_no_notes: "Aucune note interne pour l'instant.",
    ticket_update_status: "Mettre à jour le statut",
    ticket_detail_title: "Détails du ticket",
    ticket_close_detail: "Fermer",
    ticket_delete: "Supprimer le ticket",
    ticket_delete_confirm: "Voulez-vous vraiment supprimer ce ticket ? Cette action est irréversible.",
    ticket_delete_yes: "Oui, supprimer",
    ticket_notif_new: (name: string) => `Nouveau ticket de support de ${name}`,
    ticket_all_clients: "Tous les clients",

    // Share App
    share_title: "Partager l'application",
    share_desc: "Invitez d'autres personnes à accéder à la plateforme. Partagez ce lien — les destinataires seront dirigés vers la page de connexion.",
