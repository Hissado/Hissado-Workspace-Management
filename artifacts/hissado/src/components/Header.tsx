...
export default function Header({ title, notifications, onNotifClick, searchQuery, onSearch, onLogout, onMobileMenuOpen }: HeaderProps) {
  const { t } = useI18n();
  ...
  return (
    <header style={{
        ...
        {isMobile && (
          <button
            ...
            style={{
              ...
              color: C.navy, display: "flex", padding: "8px",
              flexShrink: 0,
            }}
          >
            <MenuIcon />
      ...
      <div style={{ display: "flex", alignItems: "center", gap: isMobile ? 4 : 6, flexShrink: 0 }}>
        {/* Search — desktop only or when expanded on mobile */}
        {!isMobile && (
          showSearch ? (
        ...
        {isMobile && !showSearch && (
          <button
            ...
            style={{
              background: "transparent", border: "none",
              borderRadius: 9, cursor: "pointer",
              color: C.g400, display: "flex", padding: "8px",
            }}
          >
            <SearchIcon />
          </button>
        ...
        {isMobile && showSearch && (
          <div style={{ position: "relative" }}>
            <span style={{ position: "absolute", left: 8, top: "50%", transform: "translateY(-50%)", color: C.g300, display: "flex" }}>
              <SearchIcon />
            </span>
            <input
              autoFocus
              ...
              style={{
                ...
                border: `1.5px solid ${searchFocused ? C.gold : C.g200}`,
                borderRadius: 10, fontSize: 13, fontFamily: "'DM Sans', sans-serif",
                outline: "none", background: C.g50,
                width: 160, transition: "all .18s", color: C.g700,
              }}
            />
          </div>
        )}
        ...
        {!isMobile && <div style={{ width: 1, height: 24, background: C.g100, margin: "0 4px" }} />}
