        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:580px;">
          ...
          <tr>
            <td style="background:#ffffff;padding:40px 40px 32px;">
              <h1 style="color:#070D1A;font-size:22px;font-weight:700;margin:0 0 20px;line-height:1.3;">${subject}</h1>
              <p style="color:#4A5268;font-size:15px;line-height:1.7;margin:0 0 8px;">${greeting}</p>
              <p style="color:#4A5268;font-size:15px;line-height:1.7;margin:0 0 28px;">${inviteBody}</p>
              <p style="color:#4A5268;font-size:14px;margin:0 0 16px;font-weight:500;">${credentialsIntro}</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                <tr>
                  <td align="center">
                    <a href="${APP_URL}" style="display:inline-block;background:linear-gradient(135deg,#C9A96E 0%,#A8762E 100%);color:#ffffff;text-decoration:none;padding:15px 36px;border-radius:11px;font-weight:700;font-size:15px;letter-spacing:0.02em;box-shadow:0 4px 16px rgba(201,169,110,0.35);">
                      ${ctaLabel}
                    </a>
                  </td>
                </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:linear-gradient(135deg,#070D1A 0%,#0F1E35 100%);border-radius:14px;overflow:hidden;margin-bottom:28px;">
                <tr>
                  <td style="padding:24px 28px;">
                    <p style="color:#C9A96E;font-size:13px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;margin:0 0 8px;">${installTitle}</p>
                    <p style="color:rgba(255,255,255,0.65);font-size:14px;line-height:1.65;margin:0 0 20px;">${installDesc}</p>
                    ...
                    <a href="${APP_URL}" style="display:inline-block;background:linear-gradient(135deg,#C9A96E 0%,#A8762E 100%);color:#ffffff;text-decoration:none;padding:13px 28px;border-radius:10px;font-weight:700;font-size:14px;letter-spacing:0.02em;box-shadow:0 4px 14px rgba(201,169,110,0.35);">
                      ${installBtn}
                    </a>
                  </td>
                </tr>
              ...
              <p style="color:#9BA3B5;font-size:13px;line-height:1.6;margin:0;text-align:center;">${helpText}</p>
            </td>
          </tr>
